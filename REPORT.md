...
его в первый список, иначе во второй.  
...
Данная работа научила меня работать с языком программирования Prolog, понять, как устроен этот язык и какую роль в нём играет рекурсия.
Конечно, этот язык сложно применить в современном мире для решения каких-либо задач, но всё же Prolog является представителем парадигмы
логического программмирования, а эти знания будут полезны для любого программмиста. Таким образом, чтобы писать на Prolog, нужно думать
по-другому.
